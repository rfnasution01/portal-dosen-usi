...
export default function EditTahunAkademik() {
  ...
  return (
    <div className="scrollbar flex h-auto w-full overflow-y-auto rounded-3x bg-white font-mono shadow phones:flex-col">
      <div className="scrollbar flex h-full w-1/6 flex-col items-center justify-center gap-32 overflow-y-auto bg-primary-50 p-32 text-center font-sans text-primary-900 phones:h-auto phones:w-full">
